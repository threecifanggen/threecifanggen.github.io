...
var $author$project$Main$Model = F3(
	function (key, url, blogMenuClass) {
		return {blogMenuClass: blogMenuClass, key: key, url: url};
	});
...
var $author$project$Main$init = F3(
	function (flags, url, key) {
		return _Utils_Tuple2(
			A3($author$project$Main$Model, key, url, 'navbar-item is-boxed is-hoverable'),
		...
		switch (msg.$) {
			...
			default:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{blogMenuClass: 'navbar-item is-boxed is-hoverable is-active'}),
					$elm$core$Platform$Cmd$none);
		}
	});
						...
						[
							...
							_List_fromArray(
								[
									...
									$elm$html$Html$Attributes$class('is-1by1')
								]),
							_List_fromArray(
								[
									A2(
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$src(projectImage)
										]),
									_List_Nil)
								]))
						])),
								...
								[
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$elm$html$Html$text(cardTitle.a)
												])),
											A2(
											$elm$html$Html$p,
											_List_fromArray(
											...
											_List_fromArray(
												[
													$elm$html$Html$text(cardTitle.b)
												]))
										]))
								])),
							A2(
					...
					A2(
						...
						function (x) {
							return A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$href(x.a),
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('has-text-grey-light')
						]),
					_List_fromArray(
						[
...
var $author$project$Main$dsLearnCard = A4(
	...
	_Utils_Tuple2('data-science-learning', '数据科学相关的学习资料'),
	_List_fromArray(
		[
			$elm$html$Html$text('这是一个数据分析、数据工程等各种文献、书籍的阅读笔记，里面也有'),
			A2(
			$elm$html$Html$code,
			_List_Nil,
			_List_fromArray(
	...
	_List_fromArray(
		[
			_Utils_Tuple2('https://github.com/threecifanggen/data-science-learning', 'GitHub')
		]));
var $author$project$Main$fppyCard = A4(
	$author$project$Main$cardTemplate,
	'./assets/img/fppy-learn.jpg',
	_Utils_Tuple2('fppy-learn', '函数式编程的Python实现'),
	_List_fromArray(
		[
			A2(
			$elm$html$Html$code,
			...
			_List_fromArray(
				[
					$elm$html$Html$text('fppy-learn')
				])),
			$elm$html$Html$text('是一个基于Python实现的函数式编程包，里面囊括了常见的惰性列表、Y组合子、Monad、无副作用随机数生成器等特性。')
		]),
	_List_fromArray(
		[
			_Utils_Tuple2('https://pypi.org/project/fppy-learn/', 'PYPI'),
			_Utils_Tuple2('https://github.com/threecifanggen/python-functional-programming', 'GitHub')
		]));
var $elm$html$Html$h2 = _VirtualDom_node('h2');
var $elm$html$Html$section = _VirtualDom_node('section');
var $author$project$Main$socialFooter = A2(
	$elm$html$Html$footer,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('footer')
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('footer-title')
						]),
					_List_fromArray(
						[
							A2(
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$class('mx-4'),
							$elm$html$Html$Attributes$id('footer-social-column'),
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$href('https://www.zhihu.com/people/huang-bao-chen')
										]),
									_List_fromArray(
										[
											A2(
											...
											_List_fromArray(
												[
													$elm$html$Html$Attributes$class('image'),
													$elm$html$Html$Attributes$class('is-96x96')
												]),
											_List_fromArray(
												[
													A2(
													...
													_List_fromArray(
														[
															$elm$html$Html$Attributes$src('./assets/img/zhihu.svg'),
															$elm$html$Html$Attributes$class('has-text-centered')
														]),
													_List_Nil)
												])),
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$href('https://www.kaggle.com/threecifanggen')
										]),
									_List_fromArray(
										[
											A2(
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															$elm$html$Html$Attributes$src('./assets/img/kaggle.svg'),
															$elm$html$Html$Attributes$class('has-text-centered')
														]),
													_List_Nil)
												])),
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$href('https://github.com/threecifanggen')
										]),
									_List_fromArray(
										[
											A2(
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															$elm$html$Html$Attributes$src('./assets/img/github.svg'),
															$elm$html$Html$Attributes$class('has-text-centered')
														]),
													_List_Nil)
												])),
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$href('https://www.linkedin.cn/injobs/in/huang-baochen-84b58347')
										]),
									_List_fromArray(
										[
											A2(
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															$elm$html$Html$Attributes$src('./assets/img/linkedin.svg'),
															$elm$html$Html$Attributes$class('has-text-centered')
														]),
													_List_Nil)
												])),
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$href('https://stackoverflow.com/users/5387442/huang-baochen')
										]),
									_List_fromArray(
										[
											A2(
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															$elm$html$Html$Attributes$src('./assets/img/stackoverflow.svg'),
															$elm$html$Html$Attributes$class('has-text-centered')
														]),
													_List_Nil)
												])),
											...
											_List_fromArray(
												[
													$elm$html$Html$text('StackOverFlow')
												]))
										]))
								]))
						]))
			...
			[
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text('这里汇总了我在网络世界的大部分创作和痕迹。')
											]))
									]))
							]))
					])),
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('section'),
						$elm$html$Html$Attributes$class('is-large'),
						$elm$html$Html$Attributes$class('has-background-light')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('title'),
								$elm$html$Html$Attributes$class('has-text-centered'),
								$elm$html$Html$Attributes$class('has-text-grey-darker')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('我的开源项目')
							])),
						A2($elm$html$Html$br, _List_Nil, _List_Nil),
						A2(
						$elm$html$Html$div,
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[$author$project$Main$dsLearnCard])),
										A2(
										$elm$html$Html$div,
										_List_fromArray(
											[
										...
										_List_fromArray(
											[$author$project$Main$artUniverseCard]))
									]))
							]))
					])),
				A2(
				...
				$author$project$Main$socialFooter,
